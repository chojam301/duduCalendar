...
public class DuduLoginVO implements Serializable {
	...
	public String toString() {
		return "DuduLoginVO [id=" + id + ", name=" + name + ", ihidNum=" + ihidNum + ", email=" + email + ", password="
				+ password + ", passwordHint=" + passwordHint + ", passwordCnsr=" + passwordCnsr + ", userSe=" + userSe
				+ ", position=" + position + ", orgnztId=" + orgnztId + ", orgnztNm=" + orgnztNm + ", uniqId=" + uniqId
				+ ", url=" + url + ", ip=" + ip + ", dn=" + dn + ", ofcpsNm=" + ofcpsNm + ", auth=" + auth
