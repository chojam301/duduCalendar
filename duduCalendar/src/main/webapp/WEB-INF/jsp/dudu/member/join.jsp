...
window.onpageshow = function(event) {
    if ( event.persisted || (window.performance && window.performance.navigation.type == 2)) {
        ...
        // 이벤트 추가하는 곳
        $('#applcntEmailAdres').val("");
        $('#entrprsMberPassword').val("");
        $('#entrprsMberPassword2').val("");
        $('#cmpnyNm').val("");
        location.reload();
        console.log("새로고침");
	}
	...
	<tbody>
		...
		<tr>
			<td class="left">
				...
				<input type="password" id="entrprsMberPassword" name="entrprsMberPassword" title="비밀번호" class="pw-content" size="50" maxlength="20" placeholder="문자, 숫자, 특수문자 최소 1개씩 포함" />
			</td>
		</tr>
		<!-- 비밀번호확인 -->
		<tr>
		...
		<tr>
			<td class="left">
				...
				<input name="cmpnyNm" id="cmpnyNm" title="성명" class="name-content" size="20" maxlength="20" placeholder="본명을 입력해주세요" />
			</td>
		</tr>
		<!-- 부서 -->
		<tr>
