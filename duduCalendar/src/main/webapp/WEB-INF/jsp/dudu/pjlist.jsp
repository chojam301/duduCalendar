		...
		<div id="pj_${modal.pjno}" class="modal">
			<div class="modal_body" style="text-align: center">
				...
				<div class="modaltitle">
					...
					<div style="justify-content:flex-end; width:345px;"><a href="#this" onclick="closedd('${modal.pjno}')">X</a></div>
				</div>
					...
					<tr style="height:150px; border:none">
						<td colspan="3">
							...
							<c:if test="${sessionScope.loginMember.auth >= '3' }">
								...
								<c:if test="${modal.username eq sessionScope.loginMember.name}">
								<div>
					...
					<tr>
						...
						<div>
							<div style="display:flex; justify-content:center;">
								<select style="width: 200px;height: 40px;font-size: 12pt;margin: 5px;" name="daproject" id="daproject">
